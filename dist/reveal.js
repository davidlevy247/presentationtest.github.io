...
!(function (e, t) {
    ...
    (Z.exports = function (e, t, n, i) {
        var r,
            ...
            o = !!i && !!i.enumerable,
            s = !!i && !!i.noTargetGet;
        "function" == typeof n && ("string" != typeof t || Be(n, "name") || _e(n, "name", t), (r = Ke(n)).source || (r.source = Ye.join("string" == typeof t ? t : ""))),
            e !== Ue ? (a ? !s && e[t] && (o = !0) : delete e[t], o ? (e[t] = n) : _e(e, t, n)) : o ? (e[t] = n) : qe(t, n);
    ...
    var En = un && +un,
        ...
        Kn = function (e) {
            ...
            return function (l, c, u, d) {
                for (var h, f, v = Bn(l), p = _n(v), g = Un(c, u, 3), m = qn(p.length), y = 0, b = d || Wn, w = t ? b(l, m) : n || o ? b(l, 0) : void 0; m > y; y++)
    ...
    (Br && qr) ||
        ...
        Ur
            ...
            : Or.addEventListener && "function" == typeof postMessage && !Or.importScripts && _r && "file:" !== _r.protocol && !Dr(Zr)
    ...
    var xa,
        ...
        No = function (e, t, n) {
            var i, r;
            So ? (((i = yo.createEvent("Event")).promise = t), (i.reason = n), i.initEvent(e, !1, !0), ja.dispatchEvent(i)) : (i = { promise: t, reason: n }),
    ...
    var Yo = W,
        ...
        ns = function (e) {
            var t,
                ...
                h = ts(s),
                f = 0;
            if ((d && (u = $o(u, c > 2 ? arguments[2] : void 0, 2)), null == h || (l == Array && Qo(h)))) for (n = new l((t = Zo(s.length))); t > f; f++) (o = d ? u(s[f], f) : s[f]), es(n, f, o);
            else for (a = (r = h.call(s)).next, n = new l(); !(i = a.call(r)).done; f++) (o = d ? Jo(r, u, [i.value, f], !0) : i.value), es(n, f, o);
            return (n.length = f), n;
        };
    Xt(
        {
    ...
    var ks,
        ...
        zs = function () {
            ...
            zs = ks
                ...
                : (((t = Os("iframe")).style.display = "none"), Ts.appendChild(t), (t.src = String("javascript:")), (e = t.contentWindow.document).open(), e.write(Fs("document.F=Object")), e.close(), e.F);
    ...
    var Hs =
        ...
        cl = function (e, t, n, i, r, a, o) {
            ...
            if (
                (g && ((s = Xs(g.call(new e()))), el !== Object.prototype && s.next && (Xs(s) !== el && ($s ? $s(s, el) : "function" != typeof s[nl] && Js(s, nl, ol)), Gs(s, d, !0))),
                r == rl &&
                    v &&
                    v.name !== rl &&
                    ((h = !0),
                ...
                if (((l = { values: u(rl), keys: a ? p : u(il), entries: u(al) }), o)) for (c in l) (tl || h || !(c in f)) && Qs(f, c, l[c]);
    ...
    cl(
        ...
        function () {
            var e,
                ...
                n = t.string,
                i = t.index;
            return i >= n.length ? { value: void 0, done: !0 } : ((e = sl(n, i)), (t.index += e.length), { value: e, done: !1 });
        }
    );
    var fl = "\t\n\v\f\r                　\u2028\u2029\ufeff",
        vl = g,
    ...
    var Nl = Xe,
        ...
        jc = function (e, t, n) {
            e === bc && jc(Lc, t, n), Wl(e);
            var i = Yl(t, !0);
            return Wl(n), _l(xc, i) ? (n.enumerable ? (_l(e, vc) && e[vc][i] && (e[vc][i] = !1), (n = $l(n, { enumerable: Xl(0, !1) }))) : (_l(e, vc) || kc(e, vc, Xl(1, {})), (e[vc][i] = !0)), Tc(e, i, n)) : kc(e, i, n);
        },
        Fc = function (e, t) {
            Wl(e);
            var n = Kl(t),
        ...
        (fu = function (e) {
            ...
            return (
                o &&
                    ...
                    a.lastIndex > 0 && (!a.multiline || (a.multiline && "\n" !== e[a.lastIndex - 1])) && ((l = "(?: " + l + ")"), (u = " " + u), c++),
                    (n = new RegExp("^(?:" + l + ")", s))),
                gu && (n = new RegExp("^" + l + "$(?!\\s)", s)),
                vu && (t = a.lastIndex),
                (i = du.call(o ? n : a, u)),
                o ? (i ? ((i.input = i.input.slice(c)), (i[0] = i[0].slice(c)), (i.index = a.lastIndex), (a.lastIndex += i[0].length)) : (a.lastIndex = 0)) : vu && i && (a.lastIndex = a.global ? i.index + i[0].length : t),
                gu &&
                    i &&
                    i.length > 1 &&
            ...
            if (!a || !o || ("replace" === e && (!Ru || !xu || Pu)) || ("split" === e && !Cu)) {
                var s = /./[r],
                    l = n(
                        ...
                        function (e, t, n, i, r) {
                            var o = t.exec;
                            return o === bu || o === Au.exec ? (a && !r ? { done: !0, value: s.call(t, n, i) } : { done: !0, value: e.call(n, t, i) }) : { done: !1 };
                        },
                ...
                (i =
                    "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length
                        ? function (e, n) {
                              ...
                              for (
                                  var a, o, s, l = [], c = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e.sticky ? "y" : ""), u = 0, d = new RegExp(e.source, c + "g");
                                  (a = ud.call(d, i)) && !((o = d.lastIndex) > u && (l.push(i.slice(u, a.index)), a.length > 1 && a.index < i.length && hd.apply(l, a.slice(1)), (s = a[0].length), (u = o), l.length >= r));
    ...
    if (bd(Md, !Id(" 0o1") || !Id("0b1") || Id("+0x1"))) {
        for (
            var jd,
                ...
                zd = md ? Ld(Id) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger,fromString,range".split(","),
                Hd = 0;
            zd.length > Hd;
            Hd++
        )
        ...
        return [
            ...
            function (e, i) {
                ...
                for (var p, g = "", m = 0, y = 0; y < f.length; y++) {
                    v = f[y];
                    for (var b = String(v[0]), w = uh(dh(ah(v.index), c.length), 0), E = [], S = 1; S < v.length; S++) E.push(void 0 === (p = v[S]) ? p : String(p));
                    var k = v.groups;
                    if (u) {
    ...
    var mh = function (e, t) {
        ...
        Ih = /(iphone|ipod|ipad|android)/gi.test(Nh) || ("MacIntel" === navigator.platform && navigator.maxTouchPoints > 1),
            ...
            function L(e, t) {
                var n = Fh({}, k, t),
                    i = e.map(function (e) {
                        ...
                        return (
                            (function (e) {
                                (e.originalStyle = { whiteSpace: e.element.style.whiteSpace, display: e.element.style.display, fontSize: e.element.style.fontSize }), S(e), (e.newbie = !0), (e.dirty = !0), o.push(e);
                            })(t),
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            Array.from(e.querySelectorAll(".r-fit-text")).forEach(function (e) {
                                zh(e, { minSize: 24, maxSize: 0.8 * t.Reveal.getConfig().height, observeMutations: !1, observeWindow: !1 });
                            });
                        },
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            t &&
                                ...
                                yh(e, "video[data-lazy-loaded][src], audio[data-lazy-loaded][src], iframe[data-lazy-loaded][src]").forEach(function (e) {
                                ...
                                yh(e, "iframe[data-src]").forEach(function (e) {
                                    (kh(e, ".fragment") && !kh(e, ".fragment.visible")) ||
                                        (e.getAttribute("src") !== e.getAttribute("data-src") &&
                                            (e.removeEventListener("load", t.startEmbeddedIframe), e.addEventListener("load", t.startEmbeddedIframe), e.setAttribute("src", e.getAttribute("data-src"))));
                                }));
                        },
                    },
                    {
        ...
        { target: "Array", proto: !0, forced: !$h },
        {
            slice: function (e, t) {
                var n,
                    ...
                    s = Wh(e, o),
                    l = Wh(void 0 === t ? o : t, o);
                if (qh(a) && ("function" != typeof (n = a.constructor) || (n !== Array && !qh(n.prototype)) ? Bh(n) && null === (n = n[Gh]) && (n = void 0) : (n = void 0), n === Array || void 0 === n)) return Jh.call(a, s, l);
    ...
    var Zh = function (e) {
            ...
            if (n && n[1]) return (n = n[1]), { r: parseInt(n.slice(0, 2), 16), g: parseInt(n.slice(2, 4), 16), b: parseInt(n.slice(4, 6), 16) };
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            e.classList.remove("has-dark-background"),
                                ...
                                (n.innerHTML = ""),
                                i.background &&
                                    (/^(http|file|\/\/)/gi.test(i.background) || /\.(svg|png|jpg|jpeg|gif|bmp)([?#\s]|$)/gi.test(i.background) ? e.setAttribute("data-background-image", i.background) : (t.style.background = i.background)),
                            ...
                            if (o) {
                                var l = Zh(o);
                                l && 0 !== l.a && ("string" == typeof (a = o) && (a = Zh(a)), (a ? (299 * a.r + 587 * a.g + 114 * a.b) / 1e3 : null) < 128 ? e.classList.add("has-dark-background") : e.classList.add("has-light-background"));
                            }
                        },
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                this.previousBackground && this.Reveal.slideContent.stopEmbeddedContent(this.previousBackground, { unloadIframes: !this.Reveal.slideContent.shouldPreload(this.previousBackground) }),
                                r)
                            ) {
                        ...
                        value: function () {
                            ...
                            if (this.Reveal.getConfig().parallaxBackgroundImage) {
                                ...
                                var c,
                                    ...
                                    h = r.length;
                                (c = "number" == typeof this.Reveal.getConfig().parallaxBackgroundVertical ? this.Reveal.getConfig().parallaxBackgroundVertical : (n - d) / (h - 1)),
                                    (u = h > 0 ? c * e.v : 0),
    ...
    var af = ".slides section",
            ...
            return (
                Ri(e, [
                        ...
                        value: function (e, t) {
                            ...
                            if (
                                ...
                                if ("false" !== t.dataset.autoAnimateUnmatched && !0 === this.Reveal.getConfig().autoAnimateUnmatched) {
                                    ...
                                    this.getUnmatchedAutoAnimateElements(t).forEach(function (e) {
                                        ...
                                        (t.duration === o.duration && t.delay === o.delay) ||
                                            ((i = "unmatched-" + uf++), s.push('[data-auto-animate="running"] [data-auto-animate-target="'.concat(i, '"] { transition: opacity ').concat(t.duration, "s ease ").concat(t.delay, "s; }"))),
                                            (e.dataset.autoAnimateTarget = i);
                                    }, this),
                                        s.push('[data-auto-animate="running"] [data-auto-animate-target="unmatched"] { transition: opacity '.concat(l, "s ease ").concat(c, "s; }"));
                                }
                                (this.autoAnimateStyleSheet.innerHTML = s.join("")),
                                    ...
                                    this.Reveal.dispatchEvent({ type: "autoanimate", data: { fromSlide: e, toSlide: t, sheet: this.autoAnimateStyleSheet } });
                            }
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (e, t, n, i, r) {
                            ...
                            t.classList.contains("fragment") &&
                                ...
                                e.classList.contains("fragment") && (e.className.match(cf) || [""])[0] === (t.className.match(cf) || [""])[0] && "forward" === i.slideDirection && t.classList.add("visible", "disabled"));
                    ...
                    },
                    {
                        ...
                        value: function (e, t) {
                            var n = { easing: this.Reveal.getConfig().autoAnimateEasing, duration: this.Reveal.getConfig().autoAnimateDuration, delay: 0 };
                            ...
                            return (
                                (n.styles || i.autoAnimateStyles).forEach(function (t) {
                                    ...
                                    "string" == typeof t && (t = { property: t }),
                                        "" !== (n = void 0 !== t.from && "from" === e ? { value: t.from, explicitValue: !0 } : void 0 !== t.to && "to" === e ? { value: t.to, explicitValue: !0 } : s[t.property]) &&
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            return { x: Math.round(e.offsetLeft * t * 100) / 100, y: Math.round(e.offsetTop * t * 100) / 100, width: Math.round(e.offsetWidth * t * 100) / 100, height: Math.round(e.offsetHeight * t * 100) / 100 };
                        },
                    },
                    {
                                ...
                                Array.from(t).forEach(function (t, r) {
                                    if ((t.hasAttribute("data-fragment-index") && (r = parseInt(t.getAttribute("data-fragment-index"), 10)), (a = Math.max(a, r)), r <= e)) {
                                        ...
                                        t.classList.add("visible"),
                                            ...
                                            r === e && (n.Reveal.announceStatus(n.Reveal.getStatusText(t)), t.classList.add("current-fragment"), n.Reveal.slideContent.startEmbeddedContent(t)),
                                            o || (i.shown.push(t), n.Reveal.dispatchEvent({ target: t, type: "visible", bubbles: !1 }));
                                    } else {
                                        var s = t.classList.contains("visible");
                                        t.classList.remove("visible"),
                                            t.classList.remove("current-fragment"),
                                            s && (n.Reveal.slideContent.stopEmbeddedContent(t), i.hidden.push(t), n.Reveal.dispatchEvent({ target: t, type: "hidden", bubbles: !1 }));
                                    }
                                }),
                        ...
                        value: function (e) {
                            ...
                            if (n && this.Reveal.getConfig().fragments) {
                                ...
                                if (i.length) {
                                    ...
                                    return (
                                        a.hidden.length && this.Reveal.dispatchEvent({ type: "fragmenthidden", data: { fragment: a.hidden[0], fragments: a.hidden } }),
                                        a.shown.length && this.Reveal.dispatchEvent({ type: "fragmentshown", data: { fragment: a.shown[0], fragments: a.shown } }),
                ...
                Ri(e, [
                    {
                        ...
                        value: function () {
                            ...
                            if (this.Reveal.getConfig().overview && !this.isActive()) {
                                ...
                                this.Reveal.dispatchEvent({ type: "overviewshown", data: { indexh: n.h, indexv: n.v, currentSlide: this.Reveal.getCurrentSlide() } });
                            }
                        },
                    },
                    {
                                ...
                                t.setAttribute("data-index-h", n),
                                    ...
                                    t.classList.contains("stack") &&
                                        yh(t, "section").forEach(function (t, i) {
                                            t.setAttribute("data-index-h", n), t.setAttribute("data-index-v", i), Eh(t, "translate3d(0, " + i * e.overviewSlideHeight + "px, 0)");
                                        });
                            }),
                        ...
                        value: function () {
                            ...
                            if (this.Reveal.getConfig().overview) {
                                ...
                                this.Reveal.slide(t.h, t.v),
                                    ...
                                    this.Reveal.dispatchEvent({ type: "overviewhidden", data: { indexh: t.h, indexv: t.v, currentSlide: this.Reveal.getCurrentSlide() } });
                            }
                        },
                    },
                    {
            ...
            return (
                Ri(e, [
                    ...
                    },
                    {
                        key: "addKeyBinding",
                        value: function (e, t) {
                            "object" === Ei(e) && e.keyCode ? (this.bindings[e.keyCode] = { callback: t, key: e.key, description: e.description }) : (this.bindings[e] = { callback: t, key: null, description: null });
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            if (!(r || a || o || s)) {
                                var l,
                                    c = [66, 86, 190, 191];
                                if ("object" === Ei(t.keyboard)) for (l in t.keyboard) "togglePause" === t.keyboard[l] && c.push(parseInt(l, 10));
                                ...
                                if (!1 === f)
                                    for (l in this.bindings)
                                        if (parseInt(l, 10) === n) {
                                            ...
                                            "function" == typeof p ? p.apply(null, [e]) : "string" == typeof p && "function" == typeof this.Reveal[p] && this.Reveal[p].call(), (f = !0);
                                        }
                                !1 === f &&
                                    ((f = !0),
                                    80 === n || 33 === n
                                        ...
                                        ? this.Reveal.slide(this.Reveal.getHorizontalSlides().length - 1)
                                        : 32 === n
                                        ? (this.Reveal.overview.isActive() && this.Reveal.overview.deactivate(), e.shiftKey ? this.Reveal.prev({ skipFragments: e.altKey }) : this.Reveal.next({ skipFragments: e.altKey }))
                                        : 58 === n || 59 === n || 66 === n || 86 === n || 190 === n || 191 === n
                                        ? this.Reveal.togglePause()
                                        : 70 === n
                                        ? ((u = t.embedded ? this.Reveal.getViewportElement() : document.documentElement),
                                          (d = (u = u || document.documentElement).requestFullscreen || u.webkitRequestFullscreen || u.webkitRequestFullScreen || u.mozRequestFullScreen || u.msRequestFullscreen) && d.apply(u))
                                        : 65 === n
                                        ? t.autoSlideStoppable && this.Reveal.toggleAutoSlide(i)
                                        : (f = !1)),
                                    f ? e.preventDefault && e.preventDefault() : (27 !== n && 79 !== n) || (!1 === this.Reveal.closeOverlay() && this.Reveal.overview.toggle(), e.preventDefault && e.preventDefault()),
                                    this.Reveal.cueAutoSlide();
                            }
                        },
                    },
        ...
        pf = (function () {
            function e(t) {
                ki(this, e), xi(this, "MAX_REPLACE_STATE_FREQUENCY", 1e3), (this.Reveal = t), (this.writeURLTimeout = 0), (this.replaceStateTimestamp = 0), (this.onWindowHashChange = this.onWindowHashChange.bind(this));
            }
            return (
                Ri(e, [
                    {
                        ...
                        value: function () {
                            ...
                            (this.element = document.createElement("aside")),
                                ...
                                (this.element.innerHTML = '<button class="navigate-left" aria-label="'
                                    .concat(e ? "next slide" : "previous slide", '"><div class="controls-arrow"></div></button>\n\t\t\t<button class="navigate-right" aria-label="')
                                    .concat(
                ...
                Ri(e, [
                    {
                        ...
                        value: function (e, t) {
                            e.mouseWheel
                                ? (document.addEventListener("DOMMouseScroll", this.onDocumentMouseScroll, !1), document.addEventListener("mousewheel", this.onDocumentMouseScroll, !1))
                                : (document.removeEventListener("DOMMouseScroll", this.onDocumentMouseScroll, !1), document.removeEventListener("mousewheel", this.onDocumentMouseScroll, !1)),
                                e.hideInactiveCursor
                                    ? (document.addEventListener("mousemove", this.onDocumentCursorActive, !1), document.addEventListener("mousedown", this.onDocumentCursorActive, !1))
                                    : (this.showCursor(), document.removeEventListener("mousemove", this.onDocumentCursorActive, !1), document.removeEventListener("mousedown", this.onDocumentCursorActive, !1));
                        },
                    },
                    {
                        key: "showCursor",
        ...
        kf = function (e) {
            return function (t) {
                for (var n, i = Ef(t), r = wf(i), a = r.length, o = 0, s = []; a > o; ) (n = r[o++]), (bf && !Sf.call(i, n)) || s.push(e ? [n, i[n]] : i[n]);
                return s;
            };
        },
            ...
            function R(e, n) {
                ...
                if (i === t) {
                    if (((n.delegate = null), "throw" === n.method)) {
                        if (e.iterator.return && ((n.method = "return"), (n.arg = t), R(e, n), "throw" === n.method)) return p;
                ...
                return a
                    ? a.done
                        ? ((n[e.resultName] = a.value), (n.next = e.nextLoc), "return" !== n.method && ((n.method = "next"), (n.arg = t)), (n.delegate = null), p)
                        : a
            ...
            return (
                ...
                (P.prototype = {
                    ...
                    delegateYield: function (e, n, i) {
                        return (this.delegate = { iterator: C(e), resultName: n, nextLoc: i }), "next" === this.method && (this.arg = t), p;
                    },
                }),
                e
            );
                                            ...
                                            switch ((e.prev = e.next)) {
                                                ...
                                                case 8:
                                                    return (
                                                        ...
                                                        Rh(".reveal section>img, .reveal section>video, .reveal section>iframe{max-width: " + s + "px; max-height:" + l + "px}"),
                                                        document.documentElement.classList.add("print-pdf"),
                                                        (document.body.style.width = a + "px"),
                                                        (document.body.style.height = o + "px"),
                                                        (c = document.querySelector(".reveal-viewport")) && (d = window.getComputedStyle(c)) && d.background && (u = d.background),
                                                        (e.next = 17),
                                                        new Promise(requestAnimationFrame)
                                                    );
                                                case 17:
                                                    return this.Reveal.layoutSlideContents(s, l), (e.next = 20), new Promise(requestAnimationFrame);
                                                case 20:
                                                    return (
                                                        (h = n.map(function (e) {
                                                        ...
                                                        n.forEach(function (e, n) {
                                                            if (!1 === e.classList.contains("stack")) {
                                                                ...
                                                                ((1 === (v = Math.min(v, t.pdfMaxPagesPerSlide)) && t.center) || e.classList.contains("center")) && (c = Math.max((o - d) / 2, 0));
                                                                var p = document.createElement("div");
                                                                if (
                                                                    (f.push(p),
                                                                    (p.className = "pdf-page"),
                                                                    (p.style.height = (o + t.pdfPageHeightOffset) * v + "px"),
                                                                    ...
                                                                    e.slideBackgroundElement && p.insertBefore(e.slideBackgroundElement, e),
                                                                    t.showNotes)
                                                                ) {
                                                                    ...
                                                                    if (g) {
                                                                        ...
                                                                        y.classList.add("speaker-notes"),
                                                                            ...
                                                                            (y.innerHTML = g),
                                                                            "separate-page" === m ? f.push(y) : ((y.style.left = "8px"), (y.style.bottom = "8px"), (y.style.width = a - 16 + "px"), p.appendChild(y));
                                                                    }
                                                                }
                                                                if (i) {
                                                                    var b = n + 1,
                                                                        w = document.createElement("div");
                                                                    w.classList.add("slide-number"), w.classList.add("slide-number-pdf"), (w.innerHTML = b), p.appendChild(w);
                                                                }
                                                                if (t.pdfSeparateFragments) {
                                                                    var E,
                                                                        S = this.Reveal.fragments.sort(p.querySelectorAll(".fragment"), !0);
                                                                    ...
                                                                    yh(p, ".fragment:not(.fade-out)").forEach(function (e) {
                ...
                Ri(e, [
                    {
                        ...
                        value: function () {
                            ...
                            "onpointerdown" in window
                                ? (e.addEventListener("pointerdown", this.onPointerDown, !1), e.addEventListener("pointermove", this.onPointerMove, !1), e.addEventListener("pointerup", this.onPointerUp, !1))
                                : window.navigator.msPointerEnabled
                                ? (e.addEventListener("MSPointerDown", this.onPointerDown, !1), e.addEventListener("MSPointerMove", this.onPointerMove, !1), e.addEventListener("MSPointerUp", this.onPointerUp, !1))
                                : (e.addEventListener("touchstart", this.onTouchStart, !1), e.addEventListener("touchmove", this.onTouchMove, !1), e.addEventListener("touchend", this.onTouchEnd, !1));
                        },
                    },
                    {
                        key: "unbind",
                            ...
                            if (this.touchCaptured) Oh && e.preventDefault();
                                ...
                                if (1 === e.touches.length && 2 !== this.touchStartCount) {
                                    ...
                                    a > 40 && Math.abs(a) > Math.abs(o)
                                        ? ((this.touchCaptured = !0), "linear" === t.navigationMode ? (t.rtl ? this.Reveal.next() : this.Reveal.prev()) : this.Reveal.left())
                                        : a < -40 && Math.abs(a) > Math.abs(o)
                                        ? ((this.touchCaptured = !0), "linear" === t.navigationMode ? (t.rtl ? this.Reveal.prev() : this.Reveal.next()) : this.Reveal.right())
                                        : o > 40 && r.up
                                        ? ((this.touchCaptured = !0), "linear" === t.navigationMode ? this.Reveal.prev() : this.Reveal.up())
                                        : o < -40 && r.down && ((this.touchCaptured = !0), "linear" === t.navigationMode ? this.Reveal.next() : this.Reveal.down()),
                    ...
                    },
                    {
                        key: "onPointerDown",
                        value: function (e) {
                            (e.pointerType !== e.MSPOINTER_TYPE_TOUCH && "touch" !== e.pointerType) || ((e.touches = [{ clientX: e.clientX, clientY: e.clientY }]), this.onTouchStart(e));
                        },
                    },
                    {
                        key: "onPointerMove",
                        value: function (e) {
                            (e.pointerType !== e.MSPOINTER_TYPE_TOUCH && "touch" !== e.pointerType) || ((e.touches = [{ clientX: e.clientX, clientY: e.clientY }]), this.onTouchMove(e));
                        },
                    },
                    {
                        key: "onPointerUp",
                        value: function (e) {
                            (e.pointerType !== e.MSPOINTER_TYPE_TOUCH && "touch" !== e.pointerType) || ((e.touches = [{ clientX: e.clientX, clientY: e.clientY }]), this.onTouchEnd(e));
                        },
                    },
                ]),
                e
            ...
            return (
                Ri(e, [
                    ...
                    },
                    {
                        key: "focus",
                        value: function () {
                            this.state !== Cf && (this.Reveal.getRevealElement().classList.add("focused"), document.addEventListener("pointerdown", this.onDocumentPointerDown, !1)), (this.state = Cf);
                        },
                    },
                    {
                        key: "blur",
                        value: function () {
                            this.state !== Nf && (this.Reveal.getRevealElement().classList.remove("focused"), document.removeEventListener("pointerdown", this.onDocumentPointerDown, !1)), (this.state = Nf);
                        },
                    },
                    {
                        key: "isFocused",
    ...
    Xt(
        ...
        {
            fill: function (e) {
                for (var t = Tf(this), n = Df(t.length), i = arguments.length, r = Of(i > 1 ? arguments[1] : void 0, n), a = i > 2 ? arguments[2] : void 0, o = void 0 === a ? n : Of(a, n); o > r; ) t[r++] = e;
                return t;
            },
        }
    ),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.context.save(),
                                ...
                                this.context.stroke(),
                                this.playing && (this.context.beginPath(), this.context.arc(n, i, t, o, a, !1), (this.context.lineWidth = this.thickness), (this.context.strokeStyle = "#fff"), this.context.stroke()),
                                this.context.translate(n - 14, i - 14),
                                this.playing
                                    ? ((this.context.fillStyle = "#fff"), this.context.fillRect(0, 0, 10, r), this.context.fillRect(18, 0, 10, r))
                                    : (this.context.beginPath(), this.context.translate(4, 0), this.context.moveTo(0, 0), this.context.lineTo(24, 14), this.context.lineTo(0, r), (this.context.fillStyle = "#fff"), this.context.fill()),
    ...
    function Wf(e, t) {
        ...
        function F() {
            !0 === l.embedded ? (v.viewport = kh(e, ".reveal-viewport") || e) : ((v.viewport = document.body), document.documentElement.classList.add("reveal-full-page")), v.viewport.classList.add("reveal-viewport");
        }
        function z() {
            (c = !0),
                H(),
                ...
                k.update(!0),
                setTimeout(function () {
                    v.slides.classList.remove("no-transition"), v.wrapper.classList.add("ready"), ee({ type: "ready", data: { indexh: n, indexv: i, currentSlide: a } });
                }, 1),
                I.isPrintingPDF() &&
                    ($(),
        ...
        function U() {
            v.slides.classList.add("no-transition"),
                ...
                C.render(),
                D.render(),
                (v.pauseOverlay = Ah(v.wrapper, "div", "pause-overlay", l.controls ? '<button class="resume-button">Resume presentation</button>' : null)),
                (v.statusElement = _()),
        ...
        function Y(e) {
            ...
            if (("object" === Ei(e) && mh(l, e), !1 !== s.isReady())) {
                ...
                v.wrapper.classList.remove(t.transition),
                    ...
                    !1 === l.pause && ye(),
                    l.previewLinks ? (ne(), ie("[data-preview-link=false]")) : (ie(), ne("[data-preview-link]:not([data-preview-link=false])")),
                    S.reset(),
                    o && (o.destroy(), (o = null)),
                    n > 1 &&
                        l.autoSlide &&
                        ...
                        (b = !1)),
                    "default" !== l.navigationMode ? v.wrapper.setAttribute("data-navigation-mode", l.navigationMode) : v.wrapper.removeAttribute("data-navigation-mode"),
                    D.configure(l, t),
                    T.configure(l, t),
                    N.configure(l, t),
                    P.configure(l, t),
        ...
        function Z(e) {
            "string" == typeof e.layout && (f.layout = e.layout), "string" == typeof e.overview && (f.overview = e.overview), f.layout ? Eh(v.slides, f.layout + " " + f.overview) : Eh(v.slides, f.overview);
        }
        function ee(e) {
            var t = e.target,
        ...
        function re(e) {
            se(),
                ...
                (v.overlay.innerHTML = '<header>\n\t\t\t\t<a class="close" href="#"><span class="icon"></span></a>\n\t\t\t\t<a class="external" href="'
                    .concat(e, '" target="_blank"><span class="icon"></span></a>\n\t\t\t</header>\n\t\t\t<div class="spinner"></div>\n\t\t\t<div class="viewport">\n\t\t\t\t<iframe src="')
                    .concat(
                        e,
        ...
        function le() {
            if (v.wrapper && !I.isPrintingPDF()) {
                if (!l.disableLayout) {
                    Ih && !l.embedded && document.documentElement.style.setProperty("--vh", 0.01 * window.innerHeight + "px");
                    var e = ue(),
                        t = h;
                    ce(l.width, l.height),
                        ...
                        1 === (h = Math.min(h, l.maxScale))
                            ? ((v.slides.style.zoom = ""), (v.slides.style.left = ""), (v.slides.style.top = ""), (v.slides.style.bottom = ""), (v.slides.style.right = ""), Z({ layout: "" }))
                            : h > 1 && Dh && window.devicePixelRatio < 2
                            ? ((v.slides.style.zoom = h), (v.slides.style.left = ""), (v.slides.style.top = ""), (v.slides.style.bottom = ""), (v.slides.style.right = ""), Z({ layout: "" }))
                            : ((v.slides.style.zoom = ""),
                    ...
                    for (var n = Array.from(v.wrapper.querySelectorAll(af)), i = 0, r = n.length; i < r; i++) {
                        ...
                        "none" !== a.style.display &&
                            (l.center || a.classList.contains("center") ? (a.classList.contains("stack") ? (a.style.top = 0) : (a.style.top = Math.max((e.height - a.scrollHeight) / 2, 0) + "px")) : (a.style.top = ""));
                    }
        ...
        function ue(e, t) {
            var n = { width: l.width, height: l.height, presentationWidth: e || v.wrapper.offsetWidth, presentationHeight: t || v.wrapper.offsetHeight };
            return (
        ...
        function ke(e, t, o, s) {
            if (!ee({ type: "beforeslidechange", data: { indexh: void 0 === e ? n : e, indexv: void 0 === t ? i : t, origin: s } }).defaultPrevented) {
                r = a;
                var c = v.wrapper.querySelectorAll(of);
                if (0 !== c.length) {
                    void 0 !== t || R.isActive() || (t = he(c[e])), r && r.parentNode && r.parentNode.classList.contains("stack") && de(r.parentNode, i);
                    var u = d.concat();
                    d.length = 0;
                    var h = n || 0,
                        f = i || 0;
                    ...
                    g && ee({ type: "slidechanged", data: { indexh: n, indexv: i, previousSlide: r, currentSlide: a, origin: s } }),
        ...
        function Pe(e, t) {
            ...
            if (i) {
                ...
                c.classList.add("present"), c.removeAttribute("hidden"), c.removeAttribute("aria-hidden"), u || ee({ target: c, type: "visible", bubbles: !1 });
        ...
        function Ge() {
            ...
            (u.hasNavigatedHorizontally = !0),
                l.rtl ? (R.isActive() || r || !1 === A.next()) && Ne().left && ke(n + 1, "grid" === l.navigationMode ? i : void 0) : (R.isActive() || r || !1 === A.prev()) && Ne().left && ke(n - 1, "grid" === l.navigationMode ? i : void 0);
        }
        function Je() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                t = e.skipFragments,
            ...
            (u.hasNavigatedHorizontally = !0),
                l.rtl
                    ? (R.isActive() || r || !1 === A.prev()) && Ne().right && ke(n - 1, "grid" === l.navigationMode ? i : void 0)
                    : (R.isActive() || r || !1 === A.next()) && Ne().right && ke(n + 1, "grid" === l.navigationMode ? i : void 0);
        }
        function Qe() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                t = e.skipFragments,
        ...
        function et() {
            ...
            if (r || !1 === A.prev())
                ...
                else if ((e = l.rtl ? yh(v.wrapper, ".slides>section.future").pop() : yh(v.wrapper, ".slides>section.past").pop()) && e.classList.contains("stack")) {
        ...
        function tt() {
            ...
            if (((u.hasNavigatedHorizontally = !0), (u.hasNavigatedVertically = !0), n || !1 === A.next())) {
                var i = Ne();
                i.down && i.right && l.loop && ve() && (i.down = !1), i.down ? Ze({ skipFragments: n }) : l.rtl ? Ge({ skipFragments: n }) : Je({ skipFragments: n });
            }
        }
        function nt(e) {
        ...
        function rt(e) {
            "running" === p && /section/gi.test(e.target.nodeName) && ((p = "idle"), ee({ type: "slidetransitionend", data: { indexh: n, indexv: i, previousSlide: r, currentSlide: a } }));
        }
        function at(e) {
