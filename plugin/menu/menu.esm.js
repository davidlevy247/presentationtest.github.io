...
var J = {
    ...
    Z = t(function (e) {
        ...
        (e.exports = function (e, t, a, o) {
            var s = !!o && !!o.unsafe,
                l = !!o && !!o.enumerable,
                c = !!o && !!o.noTargetGet;
            "function" == typeof a && ("string" != typeof t || b(a, "name") || A(a, "name", t), (n(a).source = r.join("string" == typeof t ? t : ""))),
                e !== i ? (s ? !c && e[t] && (l = !0) : delete e[t], l ? (e[t] = a) : A(e, t, a)) : l ? (e[t] = a) : k(t, a);
    ...
    Ce = function (e, t) {
        ...
        if ((n = c ? i : u ? i[l] || k(l, {}) : (i[l] || {}).prototype))
            for (r in t) {
                if (((o = t[r]), (a = e.noTargetGet ? (s = Te(n, r)) && s.value : n[r]), !Le(c ? r : l + (u ? "." : "#") + r, e.forced) && void 0 !== a)) {
        ...
        Et || !xt || !wt
            ? function (e) {
                  ...
                  var t = m(this),
                      n = oe(t.length),
                      i = n - 1;
                  for (arguments.length > 1 && (i = bt(i, re(arguments[1]))), i < 0 && (i = n + i); i >= 0; i--) if (i in t && t[i] === e) return i || 0;
                  return -1;
              }
            : St;
...
(un || dn || fn) &&
    (cn = function (e) {
        ...
        return (
            ...
            un && (t = a.lastIndex),
            (i = sn.call(o ? n : a, u)),
            o ? (i ? ((i.input = i.input.slice(c)), (i[0] = i[0].slice(c)), (i.index = a.lastIndex), (a.lastIndex += i[0].length)) : (a.lastIndex = 0)) : un && i && (a.lastIndex = a.global ? i.index + i[0].length : t),
            dn &&
                i &&
                i.length > 1 &&
...
var hn,
    ...
    wn = bn("endsWith");
Ce(
    { target: "String", proto: !0, forced: !!(wn || ((hn = Sn(String.prototype, "endsWith")), !hn || hn.writable)) && !wn },
    {
        endsWith: function (e) {
            var t = String(h(this));
            gn(e);
        ...
        if (!o || !s || ("replace" === e && (!Tn || !Cn || An)) || ("split" === e && !kn)) {
            var l = /./[a],
                c = n(
                    ...
                    ""[e],
                    function (e, t, n, i, r) {
                        return t.exec === pn ? (o && !r ? { done: !0, value: l.call(t, n, i) } : { done: !0, value: e.call(n, t, i) }) : { done: !1 };
                    },
    ...
    return [
        ...
        function (e, i) {
            ...
            for (var v, g = "", y = 0, b = 0; b < h.length; b++) {
                m = h[b];
                for (var S = String(m[0]), E = jn(_n(re(m.index), u.length), 0), x = [], w = 1; w < m.length; w++) x.push(void 0 === (v = m[w]) ? v : String(v));
                var L = m.groups;
                if (f) {
            ...
            t.call(o, c, function (t, o) {
                ...
                switch (o.charAt(0)) {
                    ...
                    default:
                        ...
                        if (u > l) {
                            var f = Fn(u / 10);
                            return 0 === f ? t : f <= l ? (void 0 === r[f - 1] ? o.charAt(1) : r[f - 1] + o.charAt(1)) : t;
                        }
                        c = r[u - 1];
                }
                return void 0 === c ? "" : c;
            ...
            (i =
                "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length
                    ? function (e, n) {
                          ...
                          for (
                              var a, o, s, l = [], c = (e.ignoreCase ? "i" : "") + (e.multiline ? "m" : "") + (e.unicode ? "u" : "") + (e.sticky ? "y" : ""), u = 0, f = new RegExp(e.source, c + "g");
                              (a = pn.call(f, i)) && !((o = f.lastIndex) > u && (l.push(i.slice(u, a.index)), a.length > 1 && a.index < i.length && Bn.apply(l, a.slice(1)), (s = a[0].length), (u = o), l.length >= r));
...
Ce({ global: !0, bind: !0, forced: /MSIE .\./.test(Je) }, { setTimeout: ti(i.setTimeout), setInterval: ti(i.setInterval) });
...
export default function () {
    var e,
        ...
        n,
        i,
        r = (e = /(msie) ([\w.]+)/.exec(window.navigator.userAgent.toLowerCase())) && "msie" === e[1] ? parseFloat(e[2]) : null,
        a = !1;
    function o(e) {
        ((i = e.menu || {}).path =
            i.path ||
            ...
            !0 === i.transitions
                ...
                : !1 === i.transitions ||
                  ...
                  (console.error("reveal.js-menu error: transitions config value must be 'true' or an array of strings, eg ['None', 'Fade', 'Slide')"), (i.transitions = !1)),
    ...
    function m(e) {
        if (b())
            switch ((e.stopImmediatePropagation(), e.keyCode)) {
                ...
                case 75:
                case 38:
                    if ((s = O(".active-menu-panel .slide-menu-items li.selected") || O(".active-menu-panel .slide-menu-items li.active")))
                        A(".active-menu-panel .slide-menu-items li").forEach(function (e) {
                            e.classList.remove("selected");
                        }),
                            h(O('.active-menu-panel .slide-menu-items li[data-item="' + (parseInt(s.getAttribute("data-item")) - 1) + '"]') || s);
                ...
                case 85:
                    var t = A(".active-menu-panel .slide-menu-items li").filter(function (e) {
                        ...
                        i = t.length > 0 && Math.abs(u(t[t.length - 1])) < t[t.length - 1].clientHeight ? t[t.length - 1] : n[0];
                    i &&
    ...
    function E(e, n) {
        ...
        isNaN(r) || isNaN(a) || t.slide(r, a), o && I("theme", o), s && I("highlight-theme", s), l && t.configure({ transition: l });
        var c = O("a", e);
        c && (n || !i.sticky || (i.autoOpen && c.href.startsWith("#")) || c.href.startsWith(window.location.origin + window.location.pathname + "#")) && c.click(), g();
    }
    function x(e) {
    ...
    function w() {
        ...
        A("li.slide-menu-item, li.slide-menu-item-vertical").forEach(function (t) {
            ...
            n < e.indexh || (n === e.indexh && i < e.indexv) ? t.classList.add("past") : n === e.indexh && i === e.indexv ? t.classList.add("active") : t.classList.add("future");
        });
    }
    function L() {
    ...
    function C() {
        if (!a) {
            var e = function (e, t, n, i, r, a) {
                    var o = { "data-button": "" + T++, class: "toolbar-panel-button" + (a ? " active-toolbar-button" : "") };
                    t && (o["data-panel"] = t);
                    var s = k("li", o);
                    return (
                        n.startsWith("fa-") ? s.appendChild(k("i", { class: i + " " + n })) : (s.innerHTML = n + "</i>"),
                ...
                r = function (e, r, a, o, s) {
                    ...
                    var u = k("li", { class: e, "data-item": a, "data-slide-h": o, "data-slide-v": void 0 === s ? 0 : s });
                    if (
                        (i.markers &&
                        ...
                        var f = [],
                            d = "h.v";
                        switch (("string" == typeof i.numbers ? (d = i.numbers) : "string" == typeof n.slideNumber && (d = n.slideNumber), d)) {
                            case "c":
                                f.push(a + 1);
                                break;
                            case "c/t":
            ...
            "string" == typeof i.width && (-1 != ["normal", "wide", "third", "half", "full"].indexOf(i.width) ? u.classList.add("slide-menu--" + i.width) : (u.classList.add("slide-menu--custom"), (u.style.width = i.width))),
                c.appendChild(u),
                L();
            ...
            if (i.transitions) {
                ...
                P.appendChild(M),
                    i.transitions.forEach(function (e, t) {
                        var n = k("li", { class: "slide-menu-item", "data-transition": e.toLowerCase(), "data-item": "" + (t + 1) }, e);
            ...
            if (i.openButton) {
                var N = k("div", { class: "slide-menu-button" }),
                    R = k("a", { href: "#" });
                R.appendChild(k("i", { class: "fas fa-bars" })), N.appendChild(R), O(".reveal").appendChild(N), (N.onclick = v);
            }
        ...
        if (i.keyboard) {
            if (
                ...
                window.addEventListener("message", function (e) {
                    ...
                    t && "triggerKey" === t.method && m({ keyCode: t.args[0], stopImmediatePropagation: function () {} });
                }),
    ...
    function P(e, t, n) {
        ...
        "script" === t ? (((i = document.createElement("script")).type = "text/javascript"), (i.src = e)) : "stylesheet" === t && (((i = document.createElement("link")).rel = "stylesheet"), (i.href = e));
        var a = function () {
    ...
    function M() {
        ...
        t.isSpeakerNotes() && window.location.search.endsWith("controls=false") && (s = !1),
            s &&
                ...
                n.postMessageEvents && window.parent !== window.self && window.parent.postMessage(JSON.stringify({ namespace: "reveal", eventName: e, state: t.getState() }), "*"));
    }
    return {
        id: "menu",
        init: function (e) {
            o((n = (t = e).getConfig())),
                P(i.path + "menu.css", "stylesheet", function () {
                    void 0 === i.loadIcons || i.loadIcons ? P(i.path + "font-awesome/css/all.css", "stylesheet", M) : M();
                });
        },
        toggle: y,
        openMenu: v,
