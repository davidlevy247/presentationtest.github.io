!(function (e, t) {
        ...
        Z = t(function (e) {
            ...
            (e.exports = function (e, t, a, o) {
                var s = !!o && !!o.unsafe,
                    l = !!o && !!o.enumerable,
                    c = !!o && !!o.noTargetGet;
                "function" == typeof a && ("string" != typeof t || b(a, "name") || A(a, "name", t), (n(a).source = i.join("string" == typeof t ? t : ""))),
                    e !== r ? (s ? !c && e[t] && (l = !0) : delete e[t], l ? (e[t] = a) : A(e, t, a)) : l ? (e[t] = a) : k(t, a);
    ...
    (un || dn || fn) &&
        (cn = function (e) {
            ...
            return (
                ...
                un && (t = a.lastIndex),
                (r = sn.call(o ? n : a, u)),
                o ? (r ? ((r.input = r.input.slice(c)), (r[0] = r[0].slice(c)), (r.index = a.lastIndex), (a.lastIndex += r[0].length)) : (a.lastIndex = 0)) : un && r && (a.lastIndex = a.global ? r.index + r[0].length : t),
                dn &&
                    r &&
                    r.length > 1 &&
            ...
            if (!o || !s || ("replace" === e && (!Tn || !Cn || An)) || ("split" === e && !kn)) {
                var l = /./[a],
                    c = n(
                        ...
                        ""[e],
                        function (e, t, n, r, i) {
                            return t.exec === pn ? (o && !i ? { done: !0, value: l.call(t, n, r) } : { done: !0, value: e.call(n, t, r) }) : { done: !1 };
                        },
            ...
            return function (t, n) {
                ...
                return o < 0 || o >= s
                    ? e
                        ? ""
                        : void 0
                    : (r = a.charCodeAt(o)) < 55296 || r > 56319 || o + 1 === s || (i = a.charCodeAt(o + 1)) < 56320 || i > 57343
                    ? e
                        ? a.charAt(o)
                        : r
                    : e
                    ...
                    "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length
                        ? function (e, n) {
                              ...
                              for (
                                  ...
                                  (a = pn.call(f, r)) && !((o = f.lastIndex) > u && (l.push(r.slice(u, a.index)), a.length > 1 && a.index < r.length && Dn.apply(l, a.slice(1)), (s = a[0].length), (u = o), l.length >= i));
    ...
    Ce({ global: !0, bind: !0, forced: /MSIE .\./.test(Je) }, { setTimeout: tr(r.setTimeout), setInterval: tr(r.setInterval) });
    return (
                ...
                ((r = e.menu || {}).path =
                    ...
                    (function () {
                        ...
                        if (document.querySelector('script[src$="menu.js"]')) {
                            ...
                            e = ("undefined" == typeof document ? new (require("url").URL)("file:" + __filename).href : (document.currentScript && document.currentScript.src) || new URL("menu.js", document.baseURI).href).slice(
                                0,
                                ("undefined" == typeof document ? new (require("url").URL)("file:" + __filename).href : (document.currentScript && document.currentScript.src) || new URL("menu.js", document.baseURI).href).lastIndexOf("/") +
                                    1
                            );
                        return e;
                    })() ||
                    ...
                    !0 === r.transitions
                        ...
                        : !1 === r.transitions ||
                          ...
                          (console.error("reveal.js-menu error: transitions config value must be 'true' or an array of strings, eg ['None', 'Fade', 'Slide')"), (r.transitions = !1)),
            ...
            function C() {
                if (!a) {
                    var e = function (e, t, n, r, i, a) {
                            ...
                            var s = k("li", o);
                            return (
                                n.startsWith("fa-") ? s.appendChild(k("i", { class: r + " " + n })) : (s.innerHTML = n + "</i>"),
                    ...
                    "string" == typeof r.width && (-1 != ["normal", "wide", "third", "half", "full"].indexOf(r.width) ? u.classList.add("slide-menu--" + r.width) : (u.classList.add("slide-menu--custom"), (u.style.width = r.width))),
                        c.appendChild(u),
                        L();
                    ...
                    if (
                        ...
                        var h = function () {
                            ...
                            I = function (e) {
                                var t =
                                    "<p>ERROR: The attempt to fetch " + e.responseURL + " failed with HTTP status " + e.status + " (" + e.statusText + ").</p><p>Remember that you need to serve the presentation HTML from a HTTP server.</p>";
                                e.panel.innerHTML = t;
                            };
                        r.custom.forEach(function (e, t, n) {
                            var r = k("div", { "data-panel": "Custom" + t, class: "slide-menu-panel slide-menu-custom-panel" });
                            e.content
